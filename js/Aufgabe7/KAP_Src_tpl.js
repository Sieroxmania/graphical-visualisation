var app = (function () {
	...
	//START Aufgabe 7
	function initModels() {
		createModel("torus", "fill", [1, 1, 1, 1], [0, 0, 1], [0, 0, 0], [3, 3, 3]);
		createModel("kidneySurface", "fillwireframe", [1, 1, 1, 1], [0, 0, -2.5], [0, 0, 0], [1.25, 1.25, 1.25]);
		createModel("spiral", "fillwireframe", [1, 1, 1, 1], [0, 0, -0.25], [0, -1.5, -1.5], [1.35, 1.35, 1.35]);
		createModel("sphere", "fill", [1, 1, 1, 1], [0, 0, -0.75], [0, 0, 0], [1.25, 1.25, 1.25]);
