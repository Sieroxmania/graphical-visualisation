var app = (function () {
	...
	function initModels() {
		createModel("torus", "fill", [1, 0.519, 0.424, 1], [2, 0, 0], [0, 0, 0], [1, 1, 1]);
		createModel("plane", "wireframe", [1, 1, 1, 1], [0, -.8, 0], [0, 0, 0], [1, 1, 1]);
		createModel("sphere", "fill", [0.869, 0.659, 0.024, 1], [2, 0, 0], [20, 120, 200], [0.2, 0.2, 0.2]);
		createModel("sphere", "fill", [0.669, 0.759, 0.024, 1], [0, 0, 2], [120, 0, 270], [0.2, 0.2, 0.2]);
		createModel("sphere", "fill", [0.469, 0.659, 0.024, 1], [-2, 0, 0], [0, 180, 270], [0.2, 0.2, 0.2]);
		createModel("sphere", "fill", [0.269, 0.659, 0.024, 1], [0, 0, -2], [120, 0, 270], [0.2, 0.2, 0.2]);
	...
	function initEventHandler() {
		...
		let orbitTranslate = deltaRotate * 2;
		let torusRotate = orbitTranslate;
		var r = 2;
		...
		window.onkeydown = function (evt) {
			...
			switch (key) {
				case (75):
					...
					//Torus rotation
					interactiveModel.rotate[0] += sign * torusRotate;

					for (let i = 2; i < models.length; i++) {
						let radian = orbitTranslate + (i - 2) * deg90;
						models[i].translate[0] = Math.cos(radian) * r;
						models[i].translate[2] = Math.sin(radian) * r;
						//Sphere rotation
						models[i].rotate[0] += 1.2 * torusRotate;
					}
					break;
				case (37): //left
